let nftAbi = [
  {
    inputs: [
      ...
      { internalType: "string", name: "baseImgUrl_", type: "string" },
    ],
  ...
  },
  {
    ...
    inputs: [
      {
        indexed: false,
        internalType: "enum TankNFT.State",
        name: "_state",
        type: "uint8",
      },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "this_", type: "address" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bytes32", name: "r", type: "bytes32" },
      { internalType: "bytes32", name: "s", type: "bytes32" },
      { internalType: "uint8", name: "_count", type: "uint8" },
    ],
    name: "preMint",
    outputs: [],
  ...
  },
  {
    inputs: [],
    name: "state",
    outputs: [{ internalType: "enum TankNFT.State", name: "", type: "uint8" }],
    stateMutability: "view",
    type: "function",
  },
  {
